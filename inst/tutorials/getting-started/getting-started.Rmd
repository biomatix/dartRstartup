...
- [Worked Ex 2-1: Data Structures] *optpional*

- [Worked Ex 2-2: I/O] *optpional*

- [Worked Ex 2-3: Controlling Workflow] *optpional*

- [Worked Ex 2-4:Functions] *optpional*
...
```{r 51b, exercise = TRUE, exercise.setup = "datagl"}
# gl <- gl.filter.sexlinked(gl,"xy") # Loss of 48 loci
gl <- gl.drop.sexlinked(gl, 'xy')
gl <- gl.filter.callrate(gl, threshold=0.95) # Loss of 3522 loci
gl <- gl.filter.callrate(gl, threshold=0.7, method='ind', mono.rm=TRUE) # Loss of 1 individual, 84 loci
...
### Set up a new project and associated directory

Set up a new project and directory to house the files generated in this analysis. Set global verbosity to 3.
